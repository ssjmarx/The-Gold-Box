...
- OK No more "maxMessageContext is not a registered game setting" errors
- OK No more "Unknown message type: settings_sync_response" warnings
- OK Cleaner console output during operation
- OK No impact on existing functionality
