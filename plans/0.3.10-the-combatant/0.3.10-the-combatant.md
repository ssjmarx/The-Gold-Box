...
- [ ] AI can create combat encounters with specified actors
- [ ] AI can choose whether to roll initiative automatically
- [ ] Frontend creates combat using Foundry's native API
- [ ] Initiative rolls executed in Foundry when requested
- [ ] Combat advances to turn 1 automatically
- [ ] AI can delete/end active encounters
- [ ] Appropriate error messages for invalid states
- [ ] All tests in function_check.sh pass
- [ ] No console errors during encounter management
